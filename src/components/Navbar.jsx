...
export const Navbar = ({setDarkTheme, darkTheme}) => {
    const {setResults, setSearchTerm} = useResultContext();
    return (
        <div className="p-5 pb-0 flex flex-wrap sm:justify-between justify-center item-center border-b dark:border-gray-700 border-gray-200">
            <div className="flex justify-between item-center spaxe-x-5 w-screen">
                <Link onClick={() => {setResults([]); setSearchTerm('')}} to="/">
